        ...
        { isVisible &&
          ...
          >
            ...
            <div className="absolute w-full h-full p-8" >
              <div className="relative h-full  rounded-md " ref={ref}>
                <div className="border border-gray-200 h-full bg-white overflow-y-scroll lg:overflow-hidden">
                  <div className="relative border h-full">
                    ...
                    <div className="flex flex-col lg:grid grid-cols-12 h-full">
